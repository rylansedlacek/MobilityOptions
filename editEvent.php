...
<body>
    ...
    <main class="date">
        ...
        <form id="new-event-form" method="post">
            ...
            <label for="name">Date Of Ride </label>
            ...
            <label for="name">Would you like to make this a recurring ride? </label>

            <fieldset style="display:flex; align-items:center;border:transparent;margin-bottom:50px;">
                ...
                <div id="recurring-options" style="display:none; margin-top:6px;">
                    ...
                    <div id="custom-interval" style="display:none; margin-top:8px;">
                        <label for="custom_days">Days Between Each Trip:</label>
