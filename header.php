    ...
    if (!isset($_SESSION['logged_in'])) {
        ...
        */
        ...
        $permission_array['quickschedule.php'] = 2;
         $permission_array['calendar-view_daily.php'] = 2;
        // $permission_array['completetripform.php'] = 2;
...
<a href="eventManagement.php" style="text-decoration: none;">
  <div class="in-nav">
    <img src="images/plus-solid.svg">
    <span>Ride Management</span>
  </div>
</a>
<a href="dispatchTrip.php" style="text-decoration: none;">
  <div class="in-nav">
...
<a href="driverVehicleManagement.php" style="text-decoration: none;">
  <div class="in-nav">
