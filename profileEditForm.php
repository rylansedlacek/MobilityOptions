...
<main class="signup-form">
    ...
    <?php if ($isAdmin): ?>
        <?php if (strtolower($id) == 'vmsroot') : ?>
            <div class="error-toast">The root user profile cannot be modified</div>
</main>
</body>
<?php die() ?>
...
<div class="main-content-box">
    ...
    <form class="signup-form" method="post">
        ...
        <fieldset class="section-box">
            ...
            <input type="text" id="emergency_contact_relation" name="emergency_contact_relation" value="<?php //echo hsc($person->get_emergency_contact_relation()); 
                                                                                                        ?>" placeholder="Ex. Spouse, Mother, Father, Sister, Brother, Friend">

            <label for="emergency_contact_phone">Phone Number</label>
            <input type="tel" id="emergency_contact_phone" class="phone" name="emergency_contact_phone" value="<?php //echo formatPhoneNumber($person->get_emergency_contact_phone()); 
                                                                                                                ?>" pattern="(\D{0,1})\d{3}(\D{0,2})\d{3}(.{0,1})\d{4}" placeholder="Ex. (555) 555-5555">

            <!--<label><em>* </em>Phone Type</label>
            <div class="radio-group">
                <?php //$type = $person->get_phone1type(); 
                ?>
                <input type="radio" id="phone-type-cellphone" name="phone1type" value="cellphone" <?php //if ($type == 'cellphone') echo 'checked'; 
                                                                                                    ?> required><label for="phone-type-cellphone">Cell</label>
                <input type="radio" id="phone-type-home" name="phone1type" value="home" <?php //if ($type == 'home') echo 'checked'; 
                                                                                        ?> required><label for="phone-type-home">Home</label>
                <input type="radio" id="phone-type-work" name="phone1type" value="work" <?php //if ($type == 'work') echo 'checked'; 
        ...
        <!--<fieldset class="section-box">
            ...
            <label for="emergency_contact_first_name" required>First Name</label>
            <input type="text" id="emergency_contact_first_name" name="emergency_contact_first_name" value="<?php //echo hsc($person->get_emergency_contact_first_name()); 
                                                                                                            ?>" placeholder="Enter emergency contact name">

            <label for="emergency_contact_last_name" required>Last Name</label>
            <input type="text" id="emergency_contact_last_name" name="emergency_contact_last_name" value="<?php //echo hsc($person->get_emergency_contact_last_name()); 
                                                                                                            ?>" placeholder="Enter emergency contact name">
            ...
            <div class="radio-group">
                ...
                ?>
                <input type="radio" id="phone-type-cellphone" name="emergency_contact_phone_type" value="cellphone" <?php //if ($type == 'cellphone') echo 'checked'; 
                                                                                                                    ?> ><label for="phone-type-cellphone">Cell</label>
                <input type="radio" id="phone-type-home" name="emergency_contact_phone_type" value="home" <?php //if ($type == 'home') echo 'checked'; 
                                                                                                            ?> ><label for="phone-type-home">Home</label>
                <input type="radio" id="phone-type-work" name="emergency_contact_phone_type" value="work" <?php //if ($type == 'work') echo 'checked'; 
    ...
    <p>
        ...
        <fieldset class="section-box">
            ...
            <div class="radio-group">
                <div class="radio-element">
                    <input type="checkbox" id="reminders" name="email_prefs" value="reminders" <?php
                                                                                                if ($person->get_email_prefs() == 'true') {
                                                                                                    echo 'checked';
                                                                                                } ?>>
            ...
            <input type="text" id="skills" name="skills" value="<?php //echo hsc($person->get_skills()); 
                                                                ?>" placeholder="">

            <label>Do you have any interests?</label>
            <input type="text" id="interests" name="interests" value="<?php //echo hsc($person->get_interests()); 
                                                                        ?>" placeholder="">-->
